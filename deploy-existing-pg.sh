...
GRANT ALL ON SCHEMA public TO iotsim;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO iotsim;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO iotsim;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL ON TABLES TO iotsim;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL ON SEQUENCES TO iotsim;
SQL
...
-- Grant all permissions to iotsim user
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO iotsim;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO iotsim;
GRANT ALL PRIVILEGES ON ALL FUNCTIONS IN SCHEMA public TO iotsim;
GRANT USAGE ON SCHEMA public TO iotsim;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL ON TABLES TO iotsim;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL ON SEQUENCES TO iotsim;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL ON FUNCTIONS TO iotsim;
SQL
